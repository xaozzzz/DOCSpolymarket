...
## [wagmi + SafeMetaMask, Phantom, Rabby, and other browser wallets](https://github.com/Polymarket/wagmi-safe-builder-example)## [Privy + SafePrivy embedded wallets](https://github.com/Polymarket/privy-safe-builder-example)## [Magic Link + SafeMagic Link email/social authentication](https://github.com/Polymarket/magic-safe-builder-example)## [Turnkey + SafeTurnkey embedded wallets](https://github.com/Polymarket/turnkey-safe-builder-example)
...
## [Magic Link + ProxyAuto-deploying proxy wallets for Polymarket.com Magic users](https://github.com/Polymarket/magic-proxy-builder-example)
