...
##### Central Limit Order Book
  ...
  * REST API
    ...
    * Pricing
      ...
      * [GETGet market price](/api-reference/pricing/get-market-price)
      * [GETGet multiple market prices](/api-reference/pricing/get-multiple-market-prices)
      * [POSTGet multiple market prices by request](/api-reference/pricing/get-multiple-market-prices-by-request)
      * [GETGet midpoint price](/api-reference/pricing/get-midpoint-price)
      * [GETGet price history for a traded token](/api-reference/pricing/get-price-history-for-a-traded-token)
    * Spreads
