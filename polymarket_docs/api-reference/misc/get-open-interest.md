...
##### Data-API
  ...
  * Misc
    ...
    * [GETGet total markets a user has traded](/api-reference/misc/get-total-markets-a-user-has-traded)
    * [GETGet open interest](/api-reference/misc/get-open-interest)
    * [GETGet live volume for an event](/api-reference/misc/get-live-volume-for-an-event)
  * Builders
